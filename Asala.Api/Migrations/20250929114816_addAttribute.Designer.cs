...
namespace Asala.Api.Migrations
{
    ...
    [Migration("20250929114816_addAttribute")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asala.Core.Modules.Posts.Models.NormalPost", b =>
                {
                    b.Property<long>("PostId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("NormalPosts", (string)null);
                });
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductAttributeAssignment", (string)null);
                });

            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeLocalized", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductAttributeId", "LanguageId")
                        .IsUnique();

                    b.ToTable("ProductAttributeLocalized", (string)null);
                });

            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeValueLocalized", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductAttributeValueId", "LanguageId")
                        .IsUnique();

                    b.ToTable("ProductAttributeValueLocalized", (string)null);
                });
            ...
            modelBuilder.Entity("Asala.Core.Modules.Users.Models.Follower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asala.Core.Modules.Posts.Models.NormalPost", b =>
                {
                    b.HasOne("Asala.Core.Modules.Posts.Models.BasePost", "BasePost")
                        .WithOne("NormalPost")
                        .HasForeignKey("Asala.Core.Modules.Posts.Models.NormalPost", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeAssignment", b =>
                {
                    b.HasOne("Asala.Core.Modules.Products.Models.ProductAttributeValue", "ProductAttributeValue")
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeLocalized", b =>
                {
                    ...
                    b.HasOne("Asala.Core.Modules.Products.Models.ProductAttribute", "ProductAttribute")
                        .WithMany("ProductAttributeLocalizeds")
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeValueLocalized", b =>
                {
                    ...
                    b.HasOne("Asala.Core.Modules.Products.Models.ProductAttributeValue", "ProductAttributeValue")
                        .WithMany("ProductAttributeValueLocalizeds")
                        .HasForeignKey("ProductAttributeValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Asala.Core.Modules.Users.Models.Follower", b =>
                {
                    b.HasOne("Asala.Core.Modules.Users.Models.User", "FollowerUser")
                        .WithMany()
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Asala.Core.Modules.Users.Models.User", "FollowingUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttribute", b =>
                {
                    b.Navigation("ProductAttributeLocalizeds");
            ...
            modelBuilder.Entity("Asala.Core.Modules.Products.Models.ProductAttributeValue", b =>
                {
                    ...
                    b.Navigation("ProductAttributeValueLocalizeds");
                });
