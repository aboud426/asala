...
public static class MessageCodes
{
    ...
    public const string PERMISSION_LOCALIZED_DESCRIPTION_TOO_LONG = "PERMISSION_LOCALIZED_DESCRIPTION_TOO_LONG";
    public const string PERMISSION_LOCALIZED_LANGUAGE_ID_INVALID = "PERMISSION_LOCALIZED_LANGUAGE_ID_INVALID";
